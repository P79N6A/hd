...
var CurrentTimeDisplay = (function (_Component) {
  ...
  CurrentTimeDisplay.prototype.createEl = function createEl() {
    ...
    this.contentEl_ = Dom.createEl('div', {
      ...
      innerHTML: '<span class="vjs-control-text">Current Time </span>' + '00:00'
    }, {
...
var DurationDisplay = (function (_Component) {
  ...
  DurationDisplay.prototype.createEl = function createEl() {
    ...
    this.contentEl_ = Dom.createEl('div', {
      ...
      innerHTML: '<span class="vjs-control-text">Duration Time</span> 00:00'
    }, {
      // tell screen readers not to automatically read the time as it changes
      'aria-live': 'off'
    });
...
var Player = (function (_Component) {
   ...
   *
   * @return {Object}
   * @method creatSwicthRate
   */
  Player.prototype.creatSwicthRate = function creatSwicthRate(arr) { 
    var bar = document.getElementsByClassName('vjs-control-bar')[0];
    var divEl = document.createElement("div"); 
    divEl.className = "rateBox";
    var str = '<div class="rateList">';
    for(var i=0; i<arr.length; i++){
      if(i==0){
        str += '<span class="active">'+ arr[i] +'</span>';  
      }else{
        str += '<span>'+ arr[i] +'</span>';  
      }
    }
    str += '</div><span class="currentRate">'+ arr[0] +'</span>';
    divEl.innerHTML = str;
