...
_21.window._draggable({handle:">div.panel-header>div.panel-title",disabled:_21.options._draggable==false,onStartDrag:function(e){
if(_21.mask){
...
_21.window._resizable({disabled:_21.options._resizable==false,onStartResize:function(e){
...
return $.extend({},$.fn.panel.parseOptions(_2a),$.parser.parseOptions(_2a,[{_draggable:"boolean",_resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
