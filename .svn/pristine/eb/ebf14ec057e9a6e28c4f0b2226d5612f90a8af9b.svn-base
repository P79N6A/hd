<?php
namespace GenialCloud\Mns\Tests;
...
class QueueTest {
    ...
    public function sendMessage($messageBody) {
        ...
        //$messageBody = "test000005" . uniqid();  //测试数据
...
$mns = new QueueTest();
$mns->setUp();
$json = '{"uid":13,"order_no":"UgcB2016062116595366166800","payment":"weixinpay","amount":100}';
try {
    $res = $mns->sendMessage($json);
    var_dump($res);
