...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            var iframemainH = height + 46;
            var formmainH = height - 37;
            $(".iframe-main").attr('style', 'height:' + iframemainH + 'px');
            $(".page-quick-sidebar-main").attr('style', 'height:' + height + 'px');
            $(".form-bodymain").attr('style', 'min-height:' + formmainH + 'px');
