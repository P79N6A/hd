...
_78.each(function(){
$(this)._resizable({handles:_7c,disabled:($(this).attr("_resizable")?$(this).attr("_resizable")=="false":false),minWidth:25,onStartResize:function(e){
_74.resizing=true;
