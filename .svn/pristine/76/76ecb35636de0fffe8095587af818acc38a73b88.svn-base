...
abstract class Plugin_Cqpid {
    ...
    static function decode($message, $map_or_list, $encoding = null) {
        switch (func_num_args()) {
            case 2:
                qpid_messaging_decode($message, $map_or_list);
                break;
            default:
                qpid_messaging_decode($message, $map_or_list, $encoding);
        }
    }
    ...
    static function encode($map_or_list, $message, $encoding = null) {
        switch (func_num_args()) {
            case 2:
                qpid_messaging_encode($map_or_list, $message);
                break;
            default:
                qpid_messaging_encode($map_or_list, $message, $encoding);
        }
    }
...
class Address {
    ...
    function __construct($address_or_name = null, $subject = null, $options = null, $type = null) {
        ...
        switch (func_num_args()) {
            case 0:
                $this->_cPtr = new_qpid_messaging_Address();
                break;
            case 1:
                $this->_cPtr = new_qpid_messaging_Address($address_or_name);
                break;
            case 2:
                $this->_cPtr = new_qpid_messaging_Address($address_or_name, $subject);
                break;
            case 3:
                $this->_cPtr = new_qpid_messaging_Address($address_or_name, $subject, $options);
                break;
            default:
                $this->_cPtr = new_qpid_messaging_Address($address_or_name, $subject, $options, $type);
        }
    }
...
class Duration {
    ...
    const FOREVER = QPID_MESSAGING_DURATION_FOREVER;

    static function FOREVER() {
    ...
    const IMMEDIATE = QPID_MESSAGING_DURATION_IMMEDIATE;

    static function IMMEDIATE() {
    ...
    const SECOND = QPID_MESSAGING_DURATION_SECOND;
    ...
    const MINUTE = QPID_MESSAGING_DURATION_MINUTE;
...
class Message {
    ...
    function __construct($bytes = null, $arg2 = null) {
        ...
        switch (func_num_args()) {
            case 0:
                $this->_cPtr = new_qpid_messaging_Message();
                break;
            case 1:
                $this->_cPtr = new_qpid_messaging_Message($bytes);
                break;
            default:
                $this->_cPtr = new_qpid_messaging_Message($bytes, $arg2);
        }
    }
    ...
    function setContent($chars, $count = null) {
        switch (func_num_args()) {
            case 1:
                qpid_messaging_Message_setContent($this->_cPtr, $chars);
                break;
            default:
                qpid_messaging_Message_setContent($this->_cPtr, $chars, $count);
        }
    }
...
class Receiver {
    ...
    function __construct($impl = null) {
        ...
        switch (func_num_args()) {
            case 0:
                $this->_cPtr = new_qpid_messaging_Receiver();
                break;
            default:
                $this->_cPtr = new_qpid_messaging_Receiver($impl);
        }
    }
    ...
    function get($message_or_timeout = null, $timeout = null) {
        switch (func_num_args()) {
            case 0:
                $r = qpid_messaging_Receiver_get($this->_cPtr);
                break;
            case 1:
                $r = qpid_messaging_Receiver_get($this->_cPtr, $message_or_timeout);
                break;
            default:
                $r = qpid_messaging_Receiver_get($this->_cPtr, $message_or_timeout, $timeout);
        }
        if (!is_resource($r)) return $r;
        switch (get_resource_type($r)) {
            case '_p_qpid__messaging__Message':
                return new Message($r);
        }
    }
    ...
    function fetch($message_or_timeout = null, $timeout = null) {
        switch (func_num_args()) {
            case 0:
                $r = qpid_messaging_Receiver_fetch($this->_cPtr);
                break;
            case 1:
                $r = qpid_messaging_Receiver_fetch($this->_cPtr, $message_or_timeout);
                break;
            default:
                $r = qpid_messaging_Receiver_fetch($this->_cPtr, $message_or_timeout, $timeout);
        }
        if (!is_resource($r)) return $r;
        switch (get_resource_type($r)) {
            case '_p_qpid__messaging__Message':
...
class Sender {
    ...
    function __construct($impl = null) {
        ...
        switch (func_num_args()) {
            case 0:
                $this->_cPtr = new_qpid_messaging_Sender();
                break;
            default:
                $this->_cPtr = new_qpid_messaging_Sender($impl);
        }
    }
...
class Session {
    ...
    function __construct($impl = null) {
        ...
        switch (func_num_args()) {
            case 0:
                $this->_cPtr = new_qpid_messaging_Session();
                break;
            default:
                $this->_cPtr = new_qpid_messaging_Session($impl);
        }
    }
    ...
    function acknowledge($sync = null, $sync_ = null) {
        switch (func_num_args()) {
            case 0:
                qpid_messaging_Session_acknowledge($this->_cPtr);
                break;
            case 1:
                qpid_messaging_Session_acknowledge($this->_cPtr, $sync);
                break;
            default:
                qpid_messaging_Session_acknowledge($this->_cPtr, $sync, $sync_);
        }
    }
    ...
    function nextReceiver($timeout = null, $timeout_ = null) {
        switch (func_num_args()) {
            case 0:
                $r = qpid_messaging_Session_nextReceiver($this->_cPtr);
                break;
            case 1:
                $r = qpid_messaging_Session_nextReceiver($this->_cPtr, $timeout);
                break;
            default:
                $r = qpid_messaging_Session_nextReceiver($this->_cPtr, $timeout, $timeout_);
        }
        if (!is_resource($r)) return $r;
        switch (get_resource_type($r)) {
            case '_p_qpid__messaging__Receiver':
                return new Receiver($r);
        }
    }
...
class Connection {
    ...
    function __construct($impl_or_url = null, $options = null) {
        ...
        switch (func_num_args()) {
            case 0:
                $this->_cPtr = new_qpid_messaging_Connection();
                break;
            case 1:
                $this->_cPtr = new_qpid_messaging_Connection($impl_or_url);
                break;
            default:
                $this->_cPtr = new_qpid_messaging_Connection($impl_or_url, $options);
        }
    }
    ...
    function createTransactionalSession($name = null) {
        switch (func_num_args()) {
            case 0:
                $r = qpid_messaging_Connection_createTransactionalSession($this->_cPtr);
                break;
            default:
                $r = qpid_messaging_Connection_createTransactionalSession($this->_cPtr, $name);
        }
        if (is_resource($r)) {
            $c = substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
            if (class_exists($c)) return new $c($r);
    ...
    function createSession($name = null) {
        switch (func_num_args()) {
            case 0:
                $r = qpid_messaging_Connection_createSession($this->_cPtr);
                break;
            default:
                $r = qpid_messaging_Connection_createSession($this->_cPtr, $name);
        }
        if (is_resource($r)) {
            $c = substr(get_resource_type($r), (strpos(get_resource_type($r), '__') ? strpos(get_resource_type($r), '__') + 2 : 3));
            if (class_exists($c)) return new $c($r);
