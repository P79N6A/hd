...
_13.disabledNodes=[];
_14.dnd=true;
_15.find("div.tree-node")._draggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_16){
...
var _2a=$(_28)._draggable("proxy").find("span.tree-dnd-icon");
