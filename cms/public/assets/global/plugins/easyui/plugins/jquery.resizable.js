 ...
 */
(function($){
$.fn._resizable=function(_1,_2){
if(typeof _1=="string"){
return $.fn._resizable.methods[_1](this,_2);
}
function _3(e){
var _4=e.data;
var _5=$.data(_4.target,"_resizable").options;
...
var _d=null;
var _e=$.data(this,"_resizable");
if(_e){
$(this).unbind("._resizable");
_d=$.extend(_e.options,_1||{});
}else{
_d=$.extend({},$.fn._resizable.defaults,$.fn._resizable.parseOptions(this),_1||{});
$.data(this,"_resizable",{options:_d});
}
if(_d.disabled==true){
return;
}
...
$(document).bind("mousedown._resizable",_12,_a);
$(document).bind("mousemove._resizable",_12,_b);
$(document).bind("mouseup._resizable",_12,_c);
...
$.fn._resizable.parseOptions=function(_19){
var t=$(_19);
