...
(function($){
function _1(e){
var _2=$.data(e.data.target,"_draggable");
var _3=_2.options;
var _4=_2.proxy;
var _5=e.data;
...
function _8(e){
var _9=$.data(e.data.target,"_draggable");
var _a=_9.options;
var _b=_9.proxy;
if(!_b){
_b=$(e.data.target);
...
var _d=$.data(e.data.target,"_draggable");
var _e=_d.options;
...
function _12(e){
var _13=$.data(e.data.target,"_draggable");
_1(e);
...
_12(e);
var _17=$.data(e.data.target,"_draggable");
var _18=_17.proxy;
var _19=_17.options;
if(_19.revert){
if(_1a()==true){
...
$.fn._draggable=function(_1f,_20){
if(typeof _1f=="string"){
return $.fn._draggable.methods[_1f](this,_20);
}
return this.each(function(){
var _21;
var _22=$.data(this,"_draggable");
if(_22){
_22.handle.unbind("._draggable");
_21=$.extend(_22.options,_1f);
}else{
_21=$.extend({},$.fn._draggable.defaults,$.fn._draggable.parseOptions(this),_1f||{});
}
var _23=_21.handle?(typeof _21.handle=="string"?$(_21.handle,this):_21.handle):$(this);
$.data(this,"_draggable",{options:_21,handle:_23});
if(_21.disabled){
$(this).css("cursor","");
return;
}
_23.unbind("._draggable").bind("mousemove._draggable",{target:this},function(e){
if($.fn._draggable.isDragging){
return;
}
var _24=$.data(e.data.target,"_draggable").options;
if(_25(e)){
...
$.extend(e.data,_28);
var _29=$.data(e.data.target,"_draggable").options;
if(_29.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown._draggable",e.data,_c);
$(document).bind("mousemove._draggable",e.data,_12);
$(document).bind("mouseup._draggable",e.data,_16);
});
function _25(e){
var _2a=$.data(e.data.target,"_draggable");
var _2b=_2a.handle;
var _2c=$(_2b).offset();
...
$.fn._draggable.parseOptions=function(_2f){
var t=$(_2f);
