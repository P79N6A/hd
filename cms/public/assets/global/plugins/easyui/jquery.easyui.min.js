...
(function($){
function _1b(e){
var _1c=$.data(e.data.target,"_draggable");
var _1d=_1c.options;
var _1e=_1c.proxy;
var _1f=e.data;
...
function _21(e){
var _22=$.data(e.data.target,"_draggable");
var _23=_22.options;
var _24=_22.proxy;
if(!_24){
_24=$(e.data.target);
...
var _26=$.data(e.data.target,"_draggable");
var _27=_26.options;
...
function _2b(e){
var _2c=$.data(e.data.target,"_draggable");
_1b(e);
...
$.fn._draggable=function(_38,_39){
if(typeof _38=="string"){
return $.fn._draggable.methods[_38](this,_39);
}
return this.each(function(){
var _3a;
var _3b=$.data(this,"_draggable");
if(_3b){
_3b.handle.unbind("._draggable");
_3a=$.extend(_3b.options,_38);
}else{
_3a=$.extend({},$.fn._draggable.defaults,$.fn._draggable.parseOptions(this),_38||{});
}
var _3c=_3a.handle?(typeof _3a.handle=="string"?$(_3a.handle,this):_3a.handle):$(this);
$.data(this,"_draggable",{options:_3a,handle:_3c});
if(_3a.disabled){
$(this).css("cursor","");
return;
}
_3c.unbind("._draggable").bind("mousemove._draggable",{target:this},function(e){
if($.fn._draggable.isDragging){
return;
}
var _3d=$.data(e.data.target,"_draggable").options;
if(_3e(e)){
...
$.extend(e.data,_41);
var _42=$.data(e.data.target,"_draggable").options;
if(_42.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown._draggable",e.data,_25);
$(document).bind("mousemove._draggable",e.data,_2b);
$(document).bind("mouseup._draggable",e.data,_2f);
});
function _3e(e){
var _43=$.data(e.data.target,"_draggable");
var _44=_43.handle;
var _45=$(_44).offset();
...
$.fn._draggable.parseOptions=function(_48){
var t=$(_48);
...
(function($){
$.fn._resizable=function(_57,_58){
if(typeof _57=="string"){
return $.fn._resizable.methods[_57](this,_58);
}
function _59(e){
var _5a=e.data;
var _5b=$.data(_5a.target,"_resizable").options;
...
return this.each(function(){
var _63=null;
var _64=$.data(this,"_resizable");
if(_64){
$(this).unbind("._resizable");
_63=$.extend(_64.options,_57||{});
}else{
_63=$.extend({},$.fn._resizable.defaults,$.fn._resizable.parseOptions(this),_57||{});
$.data(this,"_resizable",{options:_63});
}
...
$(document).bind("mousedown._resizable",_67,_60);
$(document).bind("mousemove._resizable",_67,_61);
$(document).bind("mouseup._resizable",_67,_62);
...
$.fn._resizable.parseOptions=function(_6e){
var t=$(_6e);
...
_c7.disabledNodes=[];
_c8.dnd=true;
_c9.find("div.tree-node")._draggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_ca){
...
var _de=$(_dc)._draggable("proxy").find("span.tree-dnd-icon");
...
_256.window._draggable({handle:">div.panel-header>div.panel-title",disabled:_256.options._draggable==false,onStartDrag:function(e){
if(_256.mask){
...
_256.window._resizable({disabled:_256.options._resizable==false,onStartResize:function(e){
...
return $.extend({},$.fn.panel.parseOptions(_25f),$.parser.parseOptions(_25f,[{_draggable:"boolean",_resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
...
win.window({title:_280,noheader:(_280?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,_resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
_378._resizable($.extend({},{handles:_379,onStartResize:function(e){
_362=true;
...
_55e.each(function(){
$(this)._resizable({handles:_561,disabled:($(this).attr("_resizable")?$(this).attr("_resizable")=="false":false),minWidth:25,onStartResize:function(e){
_55b.resizing=true;
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,_resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,_resizable:false}]],showGroup:false,groupView:_749,groupField:"group",groupFormatter:function(_770,rows){
return _770;
}});
})(jQuery);
(function($){
...
_980.find("a.slider-handle")._draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
