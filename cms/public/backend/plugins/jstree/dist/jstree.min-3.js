    ...
    if (!e.jstree) {
        ...
        c.setAttribute("role", "treeitem"),
            ...
            e.jstree.create = function(t, s) {
                ...
                return s = e.extend(!0, {},
                    e.jstree.defaults, s),
                n && n.plugins && (s.plugins = n.plugins),
                    e.each(s.plugins,
                        function(e, t) {
            ...
            e.fn.jstree = function(i) {
                ...
                return this.each(function() {
                    var a = e.jstree.reference(this),
                        d = s && a ? a[i] : null;
                    return n = s && d ? d.apply(a, r) : null,
                    a || s || i !== t && !e.isPlainObject(i) || e(this).data("jstree", new e.jstree.create(this, i)),
                    (a && !s || i === !0) && (n = a || !1),
                        null !== n && n !== t ? !1: t
                }),
                    null !== n && n !== t ? n: this
            ...
            e.jstree.core.prototype = {
                plugin: function(t, i) {
                    ...
                    return s ? (this._data[t] = {},
                        s.prototype = this, new s(i, this)) : this
                },
                init: function(t, i) {
                    this._model = {
                        data: {
                    ...
                    this.element.on("dblclick.jstree",
                        ...
                        this)).on("keydown.jstree", ".jstree-anchor", e.proxy(function(t) {
                            ...
                            switch (t.which) {
                                ...
                                case 37:
                                    t.preventDefault(),
                                        this.is_open(t.currentTarget) ? this.close_node(t.currentTarget) : (i = this.get_prev_dom(t.currentTarget), i && i.length && i.children(".jstree-anchor").focus());
                                    break;
                                case 38:
                                    t.preventDefault(),
                                ...
                                case 46:
                                    t.preventDefault(),
                                        i = this.get_node(t.currentTarget),
                                    i && i.id && "#" !== i.id && (i = this.is_selected(i) ? this.get_selected() : i);
                                    break;
                                case 113:
                                    t.preventDefault(),
                                        i = this.get_node(t.currentTarget);
                ...
                get_next_dom: function(t, i) {
                    ...
                    if (i) {
                        s = t[0];
                        do s = this._nextSibling(s);
                        while (s && 0 === s.offsetHeight);
                        return s ? e(s) : !1
                    }
                ...
                get_prev_dom: function(t, i) {
                    ...
                    return s = t[0].parentNode.parentNode,
                        s && s.className && -1 !== s.className.indexOf("jstree-node") ? e(s) : !1
                },
                ...
                load_node: function(t, i) {
                    var s,
                        ...
                        a,
                        d;
                    if (e.isArray(t)) return this._load_nodes(t.slice(), i),
                        !0;
                    if (t = this.get_node(t), !t) return i && i.call(this, t, !1),
                        !1;
                    if (t.state.loaded) {
                        for (t.state.loaded = !1, s = 0, r = t.children_d.length; r > s; s++) {
                            ...
                            this._model.data[t.children_d[s]].state.selected && (d = !0, this._data.core.selected = e.vakata.array_remove_item(this._data.core.selected, t.children_d[s])),
                                delete this._model.data[t.children_d[s]]
                        }
                        t.children = [],
                            t.children_d = [],
                    ...
                    return t.state.loading = !0,
                        this.get_node(t, !0).addClass("jstree-loading"),
                        this._load_node(t, e.proxy(function(e) {
                                t = this._model.data[t.id],
                                    t.state.loading = !1,
                                    t.state.loaded = e;
                                var s = this.get_node(t, !0);
                                t.state.loaded && !t.children.length && s && s.length && !s.hasClass("jstree-leaf") && s.removeClass("jstree-closed jstree-open").addClass("jstree-leaf"),
                ...
                _load_node: function(t, i) {
                    ...
                    return s ? e.isFunction(s) ? s.call(this, t, e.proxy(function(s) {
                            s === !1 && i.call(this, !1),
                                this["string" == typeof s ? "_append_html_data": "_append_json_data"](t, "string" == typeof s ? e(s) : s,
                                    function(e) {
                                        i.call(this, e)
                                    })
                        },
                        this)) : "object" == typeof s ? s.url ? (s = e.extend(!0, {},
                        s), e.isFunction(s.url) && (s.url = s.url.call(this, t)), e.isFunction(s.data) && (s.data = s.data.call(this, t)), e.ajax(s).done(e.proxy(function(s, r, n) {
                            var a = n.getResponseHeader("Content-Type");
                            return - 1 !== a.indexOf("json") || "object" == typeof s ? this._append_json_data(t, s,
                                function(e) {
                                    i.call(this, e)
                                }) : -1 !== a.indexOf("html") || "string" == typeof s ? this._append_html_data(t, e(s),
                                function(e) {
                                    i.call(this, e)
                        ...
                        this))) : (r = e.isArray(s) || e.isPlainObject(s) ? JSON.parse(JSON.stringify(s)) : s, "#" === t.id ? this._append_json_data(t, r,
                        function(e) {
                            i.call(this, e)
                        }) : (this._data.core.last_error = {
                        error: "nodata",
                        ...
                        this.settings.core.error.call(this, this._data.core.last_error), i.call(this, !1))) : "string" == typeof s ? "#" === t.id ? this._append_html_data(t, e(s),
                        function(e) {
                            i.call(this, e)
                        }) : (this._data.core.last_error = {
                        error: "nodata",
                        ...
                        this.settings.core.error.call(this, this._data.core.last_error), i.call(this, !1)) : i.call(this, !1) : "#" === t.id ? this._append_html_data(t, this._data.core.original_container_html.clone(!0),
                        function(e) {
                            i.call(this, e)
                        }) : i.call(this, !1)
                },
                ...
                _append_html_data: function(t, i, s) {
                    ...
                    for (r.each(e.proxy(function(t, i) {
                            ...
                            h && (a.push(h), d.push(h), o[h].children_d.length && (d = d.concat(o[h].children_d)))
                        },
                    ...
                    this.trigger("model", {
                        ...
                        "#" !== n ? (this._node_changed(n), this.redraw()) : (this.get_container_ul().children(".jstree-initial-node").remove(), this.redraw(!0)),
                        ...
                        d = function(e, t) {
                            ...
                            var i = e.dat,
                                ...
                                m = function(e, i, s) {
                                    ...
                                    for (e && e.children && e.children === !0 && (_.state.loaded = !1, _.children = [], _.children_d = []), l[_.id] = _, n = 0, o = _.children.length; o > n; n++) c = m(l[_.children[n]], _.id, s),
                                        h = l[c],
                                        _.children_d.push(c),
                                ...
                                v = function(e, i, s) {
                                    ...
                                    if (e && e.children && e.children.length) {
                                        for (n = 0, h = e.children.length; h > n; n++) _ = v(e.children[n], g.id, s),
                                            u = l[_],
                                            g.children.push(_),
                                        u.children_d.length && (g.children_d = g.children_d.concat(u.children_d));
                                        g.children_d = g.children_d.concat(g.children)
                                    }
                                    return e && e.children && e.children === !0 && (g.state.loaded = !1, g.children = [], g.children_d = []),
                                        delete e.data,
                                        delete e.children,
                                        g.original = e,
                                        l[g.id] = g,
                            ...
                            if (i.length && i[0].id !== t && i[0].parent !== t) {
                                for (g = 0, f = i.length; f > g; g++) i[g].children || (i[g].children = []),
                                    l["" + i[g].id] = i[g];
                                for (g = 0, f = i.length; f > g; g++) l["" + i[g].parent].children.push("" + i[g].id),
                                    h.children_d.push("" + i[g].id);
                                for (g = 0, f = h.children.length; f > g; g++) u = m(l[h.children[g]], s, h.parents.concat()),
                                    n.push(u),
                                ...
                                for (g = 0, f = i.length; f > g; g++) u = v(i[g], s, h.parents.concat()),
                                u && (r.push(u), n.push(u), l[u].children_d.length && (n = n.concat(l[u].children_d)));
                ...
                _parse_model_from_html: function(i, s, r) {
                    ...
                    if (l = e.vakata.attributes(i, !0), e.each(l,
                            function(i, s) {
                                return s = e.trim(s),
                                    s.length ? (o.li_attr[i] = s, "id" === i && (o.id = "" + s), t) : !0
                            }), l = i.children("a").eq(0), l.length && (l = e.vakata.attributes(l, !0), e.each(l,
                            function(t, i) {
                                i = e.trim(i),
                                i.length && (o.a_attr[t] = i)
                            })), l = i.children("a:eq(0)").length ? i.children("a:eq(0)").clone() : i.clone(), l.children("ins, i, ul").remove(), l = l.html(), l = e("<div />").html(l), o.text = this.settings.core.force_text ? l.text() : l.html(), l = i.data(), o.data = l ? e.extend(!0, {},
                    ...
                    do h = "j" + this._id + "_" + ++this._cnt;
                    while (d[h]);
                    return o.id = o.li_attr.id ? "" + o.li_attr.id: h,
                        l.length ? (l.each(e.proxy(function(t, i) {
                                n = this._parse_model_from_html(e(i), o.id, r),
                ...
                _parse_model_from_flat_json: function(e, i, s) {
                    ...
                    for (e && e.children && e.children === !0 && (h.state.loaded = !1, h.children = [], h.children_d = []), n[h.id] = h, d = 0, o = h.children.length; o > d; d++) c = this._parse_model_from_flat_json(n[h.children[d]], h.id, s),
                        l = n[c],
                        h.children_d.push(c),
                ...
                _parse_model_from_json: function(e, i, s) {
                    ...
                    if (e && e.children && e.children.length) {
                        for (n = 0, a = e.children.length; a > n; n++) d = this._parse_model_from_json(e.children[n], h.id, s),
                            o = c[d],
                            h.children.push(d),
                        o.children_d.length && (h.children_d = h.children_d.concat(o.children_d));
                        h.children_d = h.children_d.concat(h.children)
                    }
                    return e && e.children && e.children === !0 && (h.state.loaded = !1, h.children = [], h.children_d = []),
                        delete e.data,
                        delete e.children,
                        h.original = e,
                        c[h.id] = h,
                ...
                _redraw: function() {
                    ...
                    for (s = 0, r = e.length; r > s; s++) i = this.redraw_node(e[s], !0, this._model.force_full_redraw),
                    ...
                    null !== n && (i = this.get_node(n, !0), i && i.length && i.children(".jstree-anchor")[0] !== document.activeElement ? i.children(".jstree-anchor").focus() : this._data.core.focused = null),
                ...
                redraw_node: function(t, i, s) {
                    ...
                    if (i = i || 0 === r.children.length, t = document.querySelector ? this.element[0].querySelector("#" + ( - 1 !== "0123456789".indexOf(r.id[0]) ? "\\3" + r.id[0] + " " + r.id.substr(1).replace(e.jstree.idregex, "\\$&") : r.id.replace(e.jstree.idregex, "\\$&"))) : document.getElementById(r.id)) t = e(t),
                    s || (n = t.parent().parent()[0], n === this.element[0] && (n = null), a = t.index()),
                    i || !r.children.length || t.children(".jstree-children").length || (i = !0),
                    i || (d = t.children(".jstree-children")[0]),
                        p = t.attr("aria-selected"),
                        f = t.children(".jstree-anchor")[0] === document.activeElement,
                        t.remove();
                    else if (i = !0, !s) {
                    ...
                    p && "false" !== p && t.setAttribute("aria-selected", !0),
                        r.state.loaded && !r.children.length ? _ += " jstree-leaf": (_ += r.state.opened && r.state.loaded ? " jstree-open": " jstree-closed", t.setAttribute("aria-expanded", r.state.opened && r.state.loaded)),
                    null !== r.parent && g[r.parent].children[g[r.parent].children.length - 1] === r.id && (_ += " jstree-last"),
                        t.id = r.id,
                        t.className = _,
                        _ = (r.state.selected ? " jstree-clicked": "") + (r.state.disabled ? " jstree-disabled": "");
                    ...
                    if (d && t.appendChild(d), !s) {
                        ...
                        m || (m = u.createElement("UL"), m.setAttribute("role", "group"), m.className = "jstree-children", n.appendChild(m)),
                            n = m,
                            n.childNodes.length > a ? n.insertBefore(t, n.childNodes[a]) : n.appendChild(t),
                ...
                open_node: function(i, s, r) {
                    ...
                    if (r = r === t ? this.settings.core.animation: r, !this.is_closed(i)) return s && s.call(this, i, !1),
                        !1;
                    if (this.is_loaded(i)) d = this.get_node(i, !0),
                        o = this,
                    d.length && (i.children.length && !this._firstChild(d.children(".jstree-children")[0]) && (i.state.opened = !0, this.redraw_node(i, !0), d = this.get_node(i, !0)), r ? (this.trigger("before_open", {
                        node: i
                    }), d.children(".jstree-children").css("display", "none").end().removeClass("jstree-closed").addClass("jstree-open").attr("aria-expanded", !0).children(".jstree-children").stop(!0, !0).slideDown(r,
                        function() {
                            this.style.display = "",
                ...
                close_node: function(i, s) {
                    ...
                    return i = this.get_node(i),
                        i && "#" !== i.id ? this.is_closed(i) ? !1: (s = s === t ? this.settings.core.animation: s, a = this, d = this.get_node(i, !0), d.length && (s ? d.children(".jstree-children").attr("style", "display:block !important").end().removeClass("jstree-open").addClass("jstree-closed").attr("aria-expanded", !1).children(".jstree-children").stop(!0, !0).slideUp(s,
                            function() {
                                this.style.display = "",
                ...
                open_all: function(e, t, i) {
                    ...
                    i = i || s,
                        a = this,
                        s = this.is_closed(e) ? s.find(".jstree-closed").addBack() : s.find(".jstree-closed"),
                        s.each(function() {
                            a.open_node(this,
                                function(e, s) {
                ...
                close_all: function(t, i) {
                    ...
                    s = this.is_open(t) ? s.find(".jstree-open").addBack() : s.find(".jstree-open"),
                        e(s.get().reverse()).each(function() {
                ...
                enable_node: function(i) {
                    ...
                    return i = this.get_node(i),
                        i && "#" !== i.id ? (i.state.disabled = !1, this.get_node(i, !0).children(".jstree-anchor").removeClass("jstree-disabled"), this.trigger("enable_node", {
                            node: i
                        }), t) : !1
                },
                disable_node: function(i) {
                    ...
                    return i = this.get_node(i),
                        i && "#" !== i.id ? (i.state.disabled = !0, this.get_node(i, !0).children(".jstree-anchor").addClass("jstree-disabled"), this.trigger("disable_node", {
                            node: i
                        }), t) : !1
                },
                activate_node: function(e, i) {
                    ...
                    if (this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== t ? this.get_node(this._data.core.last_clicked.id) : null, this._data.core.last_clicked && !this._data.core.last_clicked.state.selected && (this._data.core.last_clicked = null), !this._data.core.last_clicked && this._data.core.selected.length && (this._data.core.last_clicked = this.get_node(this._data.core.selected[this._data.core.selected.length - 1])), this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && (!i.shiftKey || this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent)) if (i.shiftKey) {
                        var s = this.get_node(e).id,
                            ...
                            d,
                            o;
                        for (d = 0, o = n.length; o > d; d += 1) n[d] === s && (a = !a),
                        n[d] === r && (a = !a),
                            a || n[d] === s || n[d] === r ? this.select_node(n[d], !1, !1, i) : this.deselect_node(n[d], !1, i)
                ...
                hover_node: function(e) {
                    ...
                    t && t.length && this.dehover_node(t),
                        e.children(".jstree-anchor").addClass("jstree-hovered"),//鼠标移入
                        //e.attr("id");//获取到当前id
                        e.children(".jstree-anchor").append("<i class='fa fa-remove'></i>");
                        $("#"+ e.attr("id")+" a i:eq(1)").click(function(){
                            $.get("/tpl/deletefiles?id="+e.attr("id"), function(data){
                                location.reload();
                            });
                        });
                ...
                dehover_node: function(e) {//鼠标移出
                    return e = this.get_node(e, !0),
                        $("#"+e.attr('id')+" a i:eq(1)").remove(),
                        e && e.length && e.children(".jstree-hovered").length ? (e.attr("aria-selected", !1).children(".jstree-anchor").removeClass("jstree-hovered"), this.trigger("dehover_node", {
                            node: this.get_node(e)
                        }), t) : !1
                },
                select_node: function(i, s, r, n) {
                    ...
                    return i = this.get_node(i),
                        i && "#" !== i.id ? (a = this.get_node(i, !0), i.state.selected || (i.state.selected = !0, this._data.core.selected.push(i.id), r || (a = this._open_to(i)), a && a.length && a.children(".jstree-anchor").addClass("jstree-clicked"), this.trigger("select_node", {
                            node: i,
                            selected: this._data.core.selected,
                            event: n
                ...
                deselect_node: function(i, s, r) {
                    ...
                    return i = this.get_node(i),
                        i && "#" !== i.id ? (d = this.get_node(i, !0), i.state.selected && (i.state.selected = !1, this._data.core.selected = e.vakata.array_remove_item(this._data.core.selected, i.id), d.length && d.children(".jstree-anchor").removeClass("jstree-clicked"), this.trigger("deselect_node", {
                            node: i,
                            selected: this._data.core.selected,
                            event: r
                        }), s || this.trigger("changed", {
                    ...
                    if (i) {
                        if (i.core) {
                            var r,
                                ...
                                a,
                                d;
                            if (i.core.open) return e.isArray(i.core.open) ? (r = !0, n = !1, a = this, e.each(i.core.open.concat([]),
                                function(t, d) {
                                    n = a.get_node(d),
                                    n && (a.is_loaded(d) ? (a.is_closed(d) && a.open_node(d, !1, 0), i && i.core && i.core.open && e.vakata.array_remove_item(i.core.open, d)) : (a.is_loading(d) || a.open_node(d, e.proxy(function(t, r) { ! r && i && i.core && i.core.open && e.vakata.array_remove_item(i.core.open, t.id),
                                            this.set_state(i, s)
                                        },
                                        a), 0), r = !1))
                            ...
                            i.core.scroll && i.core.scroll.top !== t && this.element.scrollTop(i.core.scroll.top),
                                ...
                                this.set_state(i, s),
                                !1;
                            if (i.core.selected) return d = this,
                                this.deselect_all(),
                                e.each(i.core.selected,
                                    function(e, t) {
                                        d.select_node(t)
                                    }),
                                ...
                                this.set_state(i, s),
                                !1;
                            if (e.isEmptyObject(i.core)) return delete i.core,
                                this.set_state(i, s),
                                !1
                        }
                ...
                refresh: function(t, i) {
                    ...
                    t || this.element.html("<ul class='" + s + "'><" + "li class='jstree-initial-node jstree-loading jstree-leaf jstree-last'><i class='jstree-icon jstree-ocl'></i><" + "a class='jstree-anchor' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" + this.get_string("Loading ...") + "</a></li></ul>"),
                        this.load_node("#",
                            function(t, i) {
                                i && (this.get_container_ul()[0].className = s, this.set_state(e.extend(!0, {},
                ...
                set_id: function(t, i) {
                    ...
                    return s = e.inArray(t.id, this._data.core.selected),
                    -1 !== s && (this._data.core.selected[s] = i),
                ...
                set_text: function(t, i) {
                    ...
                    return t = this.get_node(t),
                        t && "#" !== t.id ? (t.text = i, this.get_node(t, !0).length && this.redraw_node(t.id), this.trigger("set_text", {
                            obj: t,
                            text: i
                        }), !0) : !1
                },
                ...
                create_node: function(i, s, r, n, a) {
                    ...
                    if (r = r === t ? "last": r, !("" + r).match(/^(before|after)$/) && !a && !this.is_loaded(i)) return this.load_node(i,
                        function() {
                    ...
                    switch ("#" === i.id && ("before" === r && (r = "first"), "after" === r && (r = "last")), r) {
                        case "before":
                            d = this.get_node(i.parent),
                                r = e.inArray(i.id, d.children),
                                i = d;
                            break;
                        case "after":
                            d = this.get_node(i.parent),
                                r = e.inArray(i.id, d.children) + 1,
                                i = d;
                            break;
                        case "inside":
                        case "first":
                    ...
                    if (r > i.children.length && (r = i.children.length), s.id || (s.id = !0), !this.check("create_node", s, i, r)) return this.settings.core.error.call(this, this._data.core.last_error),
                        !1;
                ...
                rename_node: function(t, i) {
                    ...
                    return t = this.get_node(t),
                        t && "#" !== t.id ? (n = t.text, this.check("rename_node", t, this.get_parent(t), i) ? (this.set_text(t, i), this.trigger("rename_node", {
                            node: t,
                            text: i,
                            old: n
                ...
                delete_node: function(t) {
                    ...
                    if (t = this.get_node(t), !t || "#" === t.id) return ! 1;
                    if (r = this.get_node(t.parent), n = e.inArray(t.id, r.children), h = !1, !this.check("delete_node", t, r, n)) return this.settings.core.error.call(this, this._data.core.last_error),
                        !1;
                    for ( - 1 !== n && (r.children = e.vakata.array_remove(r.children, n)), a = t.children_d.concat([]), a.push(t.id), c = 0, l = a.length; l > c; c++) {
                        for (d = 0, o = t.parents.length; o > d; d++) n = e.inArray(a[c], this._model.data[t.parents[d]].children_d),
                ...
                move_node: function(i, s, r, n, a) {
                    ...
                    if (! ("" + r).match(/^(before|after)$/) && !a && !this.is_loaded(s)) return this.load_node(s,
                        function() {
                ...
                cut: function(i) {
                    ...
                    var a = [],
                        ...
                        o,
                        c;
                    for (o = 0, c = i.length; c > o; o++) d = this.get_node(i[o]),
                ...
                paste: function(e, i) {
                    return e = this.get_node(e),
                        e && r && r.match(/^(copy_node|move_node)$/) && s ? (this[r](s, e, i) && this.trigger("paste", {
                            parent: e.id,
                            node: s,
                            mode: r
                        }), s = !1, r = !1, n = !1, t) : !1
                        ...
                        l = e("<input />", {
                            ...
                            blur: e.proxy(function() {
                                    ...
                                    "" === s && (s = o),
                                        ...
                                        d.remove(),
                                        this.set_text(i, o),
                                    this.rename_node(i, e("<div></div>").text(s)[this.settings.core.force_text ? "text": "html"]()) === !1 && this.set_text(i, o)
                                },
                                this),
                            keydown: function(e) {
                                var t = e.which;
                ...
                set_theme: function(t, i) {
                    ...
                    if (i === !0) {
                        ...
                        s || (s = e.jstree.path + "/themes"),
                            i = s + "/" + t + "/style.css"
                    }
                    i && -1 === e.inArray(i, a) && (e("head").append('<link rel="stylesheet" href="' + i + '" type="text/css" />'), a.push(i)),
                ...
                hide_icon: function(t) {
                    ...
                    return t = this.get_node(t),
                        t && "#" !== t ? (t.icon = !1, this.get_node(t, !0).children(".jstree-anchor").children(".jstree-themeicon").addClass("jstree-themeicon-hidden"), !0) : !1
                },
                show_icon: function(t) {
                    ...
                    return t = this.get_node(t),
                        t && "#" !== t ? (r = this.get_node(t, !0), t.icon = r.length ? r.children(".jstree-anchor").children(".jstree-themeicon").attr("rel") : !0, t.icon || (t.icon = !0), r.children(".jstree-anchor").children(".jstree-themeicon").removeClass("jstree-themeicon-hidden"), !0) : !1
                }
            },
            e.vakata = {},
            e.vakata.attributes = function(t, i) {
                ...
                return t && t.attributes && e.each(t.attributes,
                    function(t, r) { - 1 === e.inArray(r.name.toLowerCase(), ["style", "contenteditable", "hasfocus", "tabindex"]) && null !== r.value && "" !== e.trim(r.value) && (i ? s[r.name] = r.value: s.push(r.name))
                    }),
                    s
            },
        ...
        _.className = "jstree-icon jstree-checkbox",
                ...
                this.bind = function() {
                    ...
                    this.settings.checkbox.tie_selection || this.element.on("model.jstree", e.proxy(function(e, t) {
                            var i = this._model.data,
                                ...
                                n,
                                a;
                            for (n = 0, a = r.length; a > n; n++) i[r[n]].state.checked = i[r[n]].original && i[r[n]].original.state && i[r[n]].original.state.checked,
                            i[r[n]].state.checked && this._data.checkbox.selected.push(r[n])
                        },
                        this)),
                    ( - 1 !== this.settings.checkbox.cascade.indexOf("up") || -1 !== this.settings.checkbox.cascade.indexOf("down")) && this.element.on("model.jstree", e.proxy(function(t, i) {
                            ...
                            if ( - 1 !== u.indexOf("up")) {
                                ...
                                for (a = e.vakata.array_unique(a), l = 0, h = a.length; h > l; l++) {
                                    ...
                                    while (r && "#" !== r.id) {
                                        ...
                                        if (d !== c) break;
                                        r.state[g ? "selected": "checked"] = !0,
                                            this._data[g ? "core": "checkbox"].selected.push(r.id),
                                            _ = this.get_node(r, !0),
                                        _ && _.length && _.children(".jstree-anchor").addClass(g ? "jstree-clicked": "jstree-checked"),
                        ...
                        this)).on(this.settings.checkbox.tie_selection ? "deselect_node.jstree": "uncheck_node.jstree", e.proxy(function(t, i) {
                            ...
                            if (s && s.original && s.original.state && s.original.state.undetermined && (s.original.state.undetermined = !1), -1 !== o.indexOf("down")) for (n = 0, a = s.children_d.length; a > n; n++) d = this._model.data[s.children_d[n]],
                                d.state[c ? "selected": "checked"] = !1,
                            d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1);
                            if ( - 1 !== o.indexOf("up")) for (n = 0, a = s.parents.length; a > n; n++) d = this._model.data[s.parents[n]],
                                d.state[c ? "selected": "checked"] = !1,
                            d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1),
                                d = this.get_node(s.parents[n], !0),
                            d && d.length && d.children(".jstree-anchor").removeClass(c ? "jstree-clicked": "jstree-checked");
                            ...
                            -1 !== o.indexOf("down") && r.length && r.find(".jstree-anchor").removeClass(c ? "jstree-clicked": "jstree-checked")
                        },
                        this)),
                    -1 !== this.settings.checkbox.cascade.indexOf("up") && this.element.on("delete_node.jstree", e.proxy(function(e, t) {
                            ...
                            while (i && "#" !== i.id) {
                                ...
                                i.state[o ? "selected": "checked"] = !0,
                                    ...
                                    d = this.get_node(i, !0),
                                d && d.length && d.children(".jstree-anchor").addClass(o ? "jstree-clicked": "jstree-checked"),
                            ...
                            if (!s) {
                                ...
                                while (d && "#" !== d.id) {
                                    ...
                                    d.state[_ ? "selected": "checked"] = !0,
                                        ...
                                        h = this.get_node(d, !0),
                                    h && h.length && h.children(".jstree-anchor").addClass(_ ? "jstree-clicked": "jstree-checked"),
                            ...
                            while (d && "#" !== d.id) {
                                ...
                                if (o === l) d.state[_ ? "selected": "checked"] || (d.state[_ ? "selected": "checked"] = !0, this._data[_ ? "core": "checkbox"].selected.push(d.id), h = this.get_node(d, !0), h && h.length && h.children(".jstree-anchor").addClass(_ ? "jstree-clicked": "jstree-checked"));
                                    ...
                                    d.state[_ ? "selected": "checked"] = !1,
                                        ...
                                        h = this.get_node(d, !0),
                                    h && h.length && h.children(".jstree-anchor").removeClass(_ ? "jstree-clicked": "jstree-checked")
                                }
                                d = this.get_node(d.parent)
                            }
                        },
                    ...
                    this._undetermined = function() {
                        ...
                        for (this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function() {
                            var e = d.get_node(this),
                                r;
                            if (e.state.loaded) for (t = 0, i = e.children_d.length; i > t; t++) r = s[e.children_d[t]],
                            !r.state.loaded && r.original && r.original.state && r.original.state.undetermined && r.original.state.undetermined === !0 && (a.push(r.id), a = a.concat(r.parents));
                    ...
                    this.redraw_node = function(t, i, r) {
                        ...
                        return r || -1 === this.settings.checkbox.cascade.indexOf("undetermined") || (this._data.checkbox.uto && clearTimeout(this._data.checkbox.uto), this._data.checkbox.uto = setTimeout(e.proxy(this._undetermined, this), 50)),
                            t
                    },
                    ...
                    this.activate_node = function(i, r) {
                        return this.settings.checkbox.tie_selection && (this.settings.checkbox.whole_node || e(r.target).hasClass("jstree-checkbox")) && (r.ctrlKey = !0),
                            this.settings.checkbox.tie_selection || !this.settings.checkbox.whole_node && !e(r.target).hasClass("jstree-checkbox") ? s.activate_node.call(this, i, r) : (this.is_checked(i) ? this.uncheck_node(i, r) : this.check_node(i, r), this.trigger("activate_node", {
                                node: this.get_node(i)
                            }), t)
                    },
                    this.check_node = function(i, s) {
                        ...
                        return i = this.get_node(i),
                            i && "#" !== i.id ? (r = this.get_node(i, !0), i.state.checked || (i.state.checked = !0, this._data.checkbox.selected.push(i.id), r && r.length && r.children(".jstree-anchor").addClass("jstree-checked"), this.trigger("check_node", {
                                node: i,
                    ...
                    this.uncheck_node = function(i, s) {
                        ...
                        return i = this.get_node(i),
                            i && "#" !== i.id ? (a = this.get_node(i, !0), i.state.checked && (i.state.checked = !1, this._data.checkbox.selected = e.vakata.array_remove_item(this._data.checkbox.selected, i.id), a.length && a.children(".jstree-anchor").removeClass("jstree-checked"), this.trigger("uncheck_node", {
                                node: i,
                                selected: this._data.checkbox.selected,
                                event: s
                            })), t) : !1
                ...
                this.bind = function() {
                    ...
                    this.show_contextmenu = function(i, s, r, n) {
                        ...
                        var a = this.settings.contextmenu,
                            ...
                            c = !1,
                            l = !1; (a.show_at_node || s === t || r === t) && (c = o.offset(), s = c.left, r = c.top + this._data.core.li_height),
                        ...
                        e.isFunction(l) && (l = l.call(this, i, e.proxy(function(e) {
                            ...
                            this))),
                        e.isPlainObject(l) && this._show_contextmenu(i, s, r, l)
                    },
            ...
            function(e) {
                ...
                e.vakata.context = {
                    ...
                    _parse: function(i, r) {
                        ...
                        r && (n += "</ul>"),
                        r || (s.html = n, e.vakata.context._trigger("parse")),
                            n.length > 10 ? n: !1
                    },
                    _show_submenu: function(t) {
                        if (t = e(t), t.length && t.children("ul").length) {
                            ...
                            i ? t[0 > r - (a + 10 + t.outerWidth()) ? "addClass": "removeClass"]("vakata-context-left") : t[r + a + 10 > o ? "addClass": "removeClass"]("vakata-context-right"),
                            n + d + 10 > c && s.css("bottom", "-1px"),
                                s.show()
                        }
                    },
                    show: function(t, r, n) {
                        ...
                        switch (s.element && s.element.length && s.element.width(""), g) {
                            case ! r && !t: return ! 1;
                            case !! r && !!t: s.reference = t,
                                s.position_x = r.x,
                                s.position_y = r.y;
                                break;
                            case ! r && !!t: s.reference = t,
                                a = t.offset(),
                                s.position_x = a.left + t.outerHeight(),
                                s.position_y = a.top;
                                break;
                            case !! r && !t: s.position_x = r.x,
                                s.position_y = r.y
                        }
                        t && !n && e(t).data("vakata_contextmenu") && (n = e(t).data("vakata_contextmenu")),
                        e.vakata.context._parse(n) && s.element.html(s.html),
                        s.items.length && (s.element.appendTo("body"), d = s.element, o = s.position_x, c = s.position_y, l = d.width(), h = d.height(), _ = e(window).width() + e(window).scrollLeft(), u = e(window).height() + e(window).scrollTop(), i && (o -= d.outerWidth(), e(window).scrollLeft() + 20 > o && (o = e(window).scrollLeft() + 20)), o + l + 20 > _ && (o = _ - (l + 20)), c + h + 20 > u && (c = u - (h + 20)), s.element.css({
                            left: o,
                            top: c
                    ...
                    e(function() {
                        ...
                        var t = !1;
                        s.element = e("<ul class='vakata-context'></ul>"),
                            s.element.on("mouseenter", "li",
                                function(i) {
                                    i.stopImmediatePropagation(),
                                    e.contains(this, i.relatedTarget) || (t && clearTimeout(t), s.element.find(".vakata-context-hover").removeClass("vakata-context-hover").end(), e(this).siblings().find("ul").hide().end().end().parentsUntil(".vakata-context", "li").addBack().addClass("vakata-context-hover"), e.vakata.context._show_submenu(this))
                                }).on("mouseleave", "li",
                                function(t) {
                            ...
                            e(document).on("mousedown.vakata.jstree",
                                function(t) {
                                    s.is_visible && !e.contains(s.element[0], t.target) && e.vakata.context.hide()
                                }).on("context_show.vakata.jstree",
                                function(e, t) {
                                    s.element.find("li:has(ul)").children("a").addClass("vakata-context-parent"),
                                    i && s.element.addClass("vakata-context-rtl").css("direction", "rtl"),
                                        s.element.find("ul").hide().end()
                                })
                    })
            } (e),
            ...
            e(function() {
                ...
                e(document).on("dnd_start.vakata.jstree",
                    function(e, t) {
                        i = !1,
                    ...
                    function(a, d) {
                        if (r && clearTimeout(r), d && d.data && d.data.jstree && (!d.event.target.id || "jstree-marker" !== d.event.target.id)) {
                            ...
                            if (o && o._data && o._data.dnd) if (n.attr("class", "jstree-" + o.get_theme() + (o.settings.core.themes.responsive ? " jstree-dnd-responsive": "")), d.helper.children().attr("class", "jstree-" + o.get_theme() + (o.settings.core.themes.responsive ? " jstree-dnd-responsive": "")).find(".jstree-copy:eq(0)")[d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "show": "hide"](), d.event.target !== o.element[0] && d.event.target !== o.get_container_ul()[0] || 0 !== o.get_container_ul().children().length) {
                                if (c = e(d.event.target).closest(".jstree-anchor"), c && c.length && c.parent().is(".jstree-closed, .jstree-open, .jstree-leaf") && (l = c.offset(), h = d.event.pageY - l.top, g = c.height(), m = g / 3 > h ? ["b", "i", "a"] : h > g - g / 3 ? ["a", "i", "b"] : h > g / 2 ? ["i", "a", "b"] : ["i", "b", "a"], e.each(m,
                                        function(a, h) {
                                            switch (h) {
                                                case "b":
                                                    _ = l.left - 6,
                                            ...
                                            return v ? ("i" === h && c.parent().is(".jstree-closed") && o.settings.dnd.open_timeout && (r = setTimeout(function(e, t) {
                                                ...
                                                n.css({
                                                    left: _ + "px",
                                                    top: u + "px"
                                                }).show(), d.helper.find(".jstree-icon:eq(0)").removeClass("jstree-er").addClass("jstree-ok"), s = {},
                                                m = !0, !1) : t
                                        }), m === !0)) return
                            } else {
                                ...
                                if (v) return i = {
                                    ...
                                    n.hide(),
                                    d.helper.find(".jstree-icon:eq(0)").removeClass("jstree-er").addClass("jstree-ok"),
                                    t
                            }
                            i = !1,
                    ...
                    function(t, a) {
                        if (r && clearTimeout(r), a && a.data && a.data.jstree) {
                            ...
                            var d,
                                ...
                                c = [];
                            if (i) {
                                for (d = 0, o = a.data.nodes.length; o > d; d++) c[d] = a.data.origin ? a.data.origin.get_node(a.data.nodes[d]) : a.data.nodes[d],
                            ...
                            } else d = e(a.event.target).closest(".jstree"),
                            d.length && s && s.error && "check" === s.error && (d = d.jstree(!0), d && d.settings.core.error.call(this, s))
                        }
                    }).on("keyup.jstree keydown.jstree",
                    function(t, i) {
                        i = e.vakata.dnd._get(),
                        i && i.data && i.data.jstree && i.helper.find(".jstree-copy:eq(0)")[i.data.origin && (i.data.origin.settings.dnd.always_copy || i.data.origin.settings.dnd.copy && (t.metaKey || t.ctrlKey)) ? "show": "hide"]()
                    })
            }),
            function(e) {
                var i = {
                ...
                e.vakata.dnd = {
                    ...
                    _trigger: function(t, i) {
                        ...
                        s.event = i,
                            e(document).triggerHandler("dnd_" + t + ".vakata", s)
                    },
                    _get: function() {
                        return {
                            data: i.data,
                    ...
                    _scroll: function(t) {
                        if (!i.scroll_e || !i.scroll_l && !i.scroll_t) return i.scroll_i && (clearInterval(i.scroll_i), i.scroll_i = !1),
                            !1;
                        if (!i.scroll_i) return i.scroll_i = setInterval(e.vakata.dnd._scroll, 100),
                            !1;
                        if (t === !0) return ! 1;
                        var s = i.scroll_e.scrollTop(),
                            r = i.scroll_e.scrollLeft();
                        i.scroll_e.scrollTop(s + i.scroll_t * e.vakata.dnd.settings.scroll_speed),
                            i.scroll_e.scrollLeft(r + i.scroll_l * e.vakata.dnd.settings.scroll_speed),
                        (s !== i.scroll_e.scrollTop() || r !== i.scroll_e.scrollLeft()) && e.vakata.dnd._trigger("scroll", i.scroll_e)
                    },
                    start: function(t, s, r) {
                        ...
                        r !== !1 && (i.helper = e("<div id='vakata-dnd'></div>").html(r).css({
                            display: "block",
                            margin: "0",
                            padding: "0",
                            position: "absolute",
                    ...
                    drag: function(s) {
                        if ("touchmove" === s.type && s.originalEvent && s.originalEvent.changedTouches && s.originalEvent.changedTouches[0] && (s.pageX = s.originalEvent.changedTouches[0].pageX, s.pageY = s.originalEvent.changedTouches[0].pageY, s.target = document.elementFromPoint(s.originalEvent.changedTouches[0].pageX - window.pageXOffset, s.originalEvent.changedTouches[0].pageY - window.pageYOffset)), i.is_down) {
                            if (!i.is_drag) {
                                ...
                                i.helper && (i.helper.appendTo("body"), i.helper_w = i.helper.outerWidth()),
                                    i.is_drag = !0,
                                    e.vakata.dnd._trigger("start", s)
                            }
                            var r = !1,
                                n = !1,
                                a = !1,
                            ...
                            return i.scroll_t = 0,
                                i.scroll_l = 0,
                                i.scroll_e = !1,
                                e(e(s.target).parentsUntil("body").addBack().get().reverse()).filter(function() {
                                    return /^auto|scroll$/.test(e(this).css("overflow")) && (this.scrollHeight > this.offsetHeight || this.scrollWidth > this.offsetWidth)
                                }).each(function() {
                                    var r = e(this),
                                        n = r.offset();
                                    return this.scrollHeight > this.offsetHeight && (n.top + r.height() - s.pageY < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = 1), s.pageY - n.top < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = -1)),
                                    this.scrollWidth > this.offsetWidth && (n.left + r.width() - s.pageX < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = 1), s.pageX - n.left < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = -1)),
                                        i.scroll_t || i.scroll_l ? (i.scroll_e = e(this), !1) : t
                                }),
                            i.scroll_e || (r = e(document), n = e(window), a = r.height(), d = n.height(), o = r.width(), c = n.width(), l = r.scrollTop(), h = r.scrollLeft(), a > d && s.pageY - l < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = -1), a > d && d - (s.pageY - l) < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = 1), o > c && s.pageX - h < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = -1), o > c && c - (s.pageX - h) < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = 1), (i.scroll_t || i.scroll_l) && (i.scroll_e = r)),
                            i.scroll_e && e.vakata.dnd._scroll(!0),
                            i.helper && (_ = parseInt(s.pageY + e.vakata.dnd.settings.helper_top, 10), u = parseInt(s.pageX + e.vakata.dnd.settings.helper_left, 10), a && _ + 25 > a && (_ = a - 50), o && u + i.helper_w > o && (u = o - (i.helper_w + 2)), i.helper.css({
                                left: u + "px",
                                top: _ + "px"
                            })),
                ...
                this.bind = function() {
                    s.bind.call(this),
                        ...
                        this.element.on("before_open.jstree", e.proxy(function(t, i) {
                                var s,
                                    r,
                                    n,
                                    a = this._data.search.res,
                                    d = [],
                                    o = e();
                                if (a && a.length && (this._data.search.dom = e(this.element[0].querySelectorAll("#" + e.map(a,
                                            function(t) {
                                    ...
                                    d = e.vakata.array_remove_item(e.vakata.array_unique(d), "#"),
                                        o = d.length ? e(this.element[0].querySelectorAll("#" + e.map(d,
                                                function(t) {
                                                    return - 1 !== "0123456789".indexOf(t[0]) ? "\\3" + t[0] + " " + t.substr(1).replace(e.jstree.idregex, "\\$&") : t.replace(e.jstree.idregex, "\\$&")
                                                }).join(", #"))) : e(),
                    ...
                    this.search = function(i, s) {
                        ...
                        return this._data.search.res.length && this.clear_search(),
                            s || n === !1 ? (this._data.search.str = i, this._data.search.dom = e(), this._data.search.res = [], this._data.search.opn = [], a = new e.vakata.search(i, !0, {
                                ...
                                }), d.length && (o = e.vakata.array_unique(o), this._search_open(o), this._data.search.dom = e(this.element[0].querySelectorAll("#" + e.map(d,
                                    function(t) {
                                        return - 1 !== "0123456789".indexOf(t[0]) ? "\\3" + t[0] + " " + t.substr(1).replace(e.jstree.idregex, "\\$&") : t.replace(e.jstree.idregex, "\\$&")
                                ...
                                res: this._data.search.res
                                    ...
                                    t && t.d && (t = t.d),
                                        this._load_nodes(e.isArray(t) ? e.vakata.array_unique(t) : [],
                                            function() {
                                                this.search(i, !0)
                                ...
                                this)) : (n = e.extend({},
                                n), n.data || (n.data = {}), n.data.str = i, e.ajax(n).fail(e.proxy(function() {
                                    this._data.core.last_error = {
                                        error: "ajax",
                                        plugin: "search",
                                        id: "search_01",
                    ...
                    this._search_open = function(t) {
                        ...
                        e.each(t.concat([]),
                            function(s, r) {
                                ...
                                r && r.length && i.is_closed(r) && (i._data.search.opn.push(r[0].id), i.open_node(r,
                                    function() {
                                        i._search_open(t)
                                    },
                                    0))
            ...
            e.jstree.plugins.state = function(t, i) {
                this.bind = function() {
                    ...
                    this.restore_state = function() {
                        ...
                        return t && t.ttl && t.sec && +new Date - t.sec > t.ttl ? !1: (t && t.state && (t = t.state), t && e.isFunction(this.settings.state.filter) && (t = this.settings.state.filter.call(this, t)), t ? (this.element.one("set_state.jstree",
                            function(i, s) {
            ...
            e.jstree.plugins.types = function(i, s) {
                this.init = function(e, i) {
                    ...
                    this.bind = function() {
                        this.element.on("model.jstree", e.proxy(function(e, i) {
                                var s = this._model.data,
                                    ...
                                    d,
                                    o = "default";
                                for (a = 0, d = r.length; d > a; a++) o = "default",
                                s[r[a]].original && s[r[a]].original.type && n[s[r[a]].original.type] && (o = s[r[a]].original.type),
                                s[r[a]].data && s[r[a]].data.jstree && s[r[a]].data.jstree.type && n[s[r[a]].data.jstree.type] && (o = s[r[a]].data.jstree.type),
                                    s[r[a]].type = o,
                                s[r[a]].icon === !0 && n[o].icon !== t && (s[r[a]].icon = n[o].icon);
                                s["#"].type = "#"
                            },
                            this)),
                            s.bind.call(this)
                    ...
                    this.get_json = function(t, i, r) {
                        ...
                        if (c === !1) return ! 1;
                        if (e.isArray(c)) for (n = 0, a = c.length; a > n; n++) c[n].type = c[n].id && d[c[n].id] && d[c[n].id].type ? d[c[n].id].type: "default",
                        i && i.no_id && (delete c[n].id, c[n].li_attr && c[n].li_attr.id && delete c[n].li_attr.id);
                        else c.type = c.id && d[c.id] && d[c.id].type ? d[c.id].type: "default",
                    ...
                    this.set_type = function(i, s) {
                        ...
                        return r = this.settings.types,
                            i = this.get_node(i),
                            r[s] && i ? (d = i.type, o = this.get_icon(i), i.type = s, (o === !0 || r[d] && r[d].icon && o === r[d].icon) && this.set_icon(i, r[s].icon !== t ? r[s].icon: !0), !0) : !1
                    }
            },
                    ...
                    switch (c || (d = d.toLowerCase()), t) {
                        ...
                        case "copy_node":
                            ...
                            h || (this._data.core.last_error = {
                                ...
                                h;
                        case "move_node":
                            return h = i.parent === r.id || -1 === e.inArray(d, o),
                            h || (this._data.core.last_error = {
                                error: "check",
                                plugin: "unique",
                                id: "unique_03",
                ...
                this.bind = function() {
                        ...
                        this.element.on("ready.jstree set_state.jstree", e.proxy(function() {
                            ...
                            this)).on("changed.jstree", e.proxy(function(e, t) {
                                ...
                                var i = !1,
                                    s,
                                    r;
                                for (s = 0, r = t.selected.length; r > s; s++) i = this.get_node(t.selected[s], !0),
                    ...
                    this.redraw_node = function(t, s, r) {
                        if (t = i.redraw_node.call(this, t, s, r)) {
                            var n = g.cloneNode(!0); - 1 !== e.inArray(t.id, this._data.core.selected) && (n.className += " jstree-wholerow-clicked"),
