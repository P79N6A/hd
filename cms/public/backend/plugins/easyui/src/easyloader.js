...
(function(){
	var modules = {
		_draggable:{
			js:'jquery._draggable.js'
		},
		droppable:{
			js:'jquery.droppable.js'
		},
		_resizable:{
			js:'jquery._resizable.js'
		},
		linkbutton:{
		...
		datagrid:{
			...
			css:'datagrid.css',
			dependencies:['panel','_resizable','linkbutton','pagination']
		},
		treegrid:{
		...
		window:{
			js:'jquery.window.js',
			css:'window.css',
			dependencies:['_resizable','_draggable','panel']
		},
		dialog:{
			js:'jquery.dialog.js',
			css:'dialog.css',
		...
		tree:{
			js:'jquery.tree.js',
			css:'tree.css',
			dependencies:['_draggable','droppable']
		},
		datebox:{
