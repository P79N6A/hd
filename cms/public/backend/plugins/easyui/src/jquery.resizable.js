...
//	var isResizing = false;
	$.fn._resizable = function(options, param){
		...
		function resize(e){
			...
			var options = $.data(resizeData.target, '_resizable').options;
...
//			$('body').css('cursor','auto');
		...
		return this.each(function(){
			...
			// bind mouse event using namespace _resizable
			$(this).bind('mousemove._resizable', {target:this}, function(e){
//				if (isResizing) return;
				if ($.fn._resizable.isResizing){return}
				...
				$(document).bind('mousedown._resizable', data, doDown);
				$(document).bind('mousemove._resizable', data, doMove);
				$(document).bind('mouseup._resizable', data, doUp);
