...
INSERT INTO `admin` VALUES (1,1,'13837837835','张三',123456789,123);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='权限授权表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `auth_assign` VALUES (1,0,1,1),(2,0,1,2),(3,0,1,3),(4,0,1,4),(5,0,1,5),(6,0,1,6);
...
CREATE TABLE `auth_element` (
  ...
  `hide` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否显示',
  PRIMARY KEY (`id`),
  UNIQUE KEY `controller` (`controller`,`action`),
  KEY `hide` (`hide`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='权限原子表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `auth_element` VALUES (1,'auth','index','权限管理',0),(2,'index','index','欢迎页',0),(3,'auth','list','权限列表',0),(4,'auth','role','角色列表',0),(5,'admin','add','添加员工',1),(6,'admin','list','员工列表',0);
...
CREATE TABLE `auth_module` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '模块ID',
  ...
  KEY `sort` (`sort`),
  KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='权限模块表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `auth_module` VALUES (1,'个人中心',0,'1,2,3','icon-users',0),(2,'权限管理',0,'','icon-settings',0),(3,'媒资管理',0,'','icon-bar-chart',0),(4,'发布管理',0,'','icon-wallet',0),(5,'会员管理',0,'','icon-present',0),(6,'员工管理',0,'5,6','icon-user',0),(7,'频道信息',0,'','icon-folder',0),(8,'系统管理',0,'','icon-settings',0);
...
CREATE TABLE `channel` (
  ...
  KEY `name` (`name`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='频道表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `channel` VALUES (1,1,1),(2,1,1);
...
INSERT INTO `site` VALUES (2,2,2,'34','454','t545','324ds45',0);
...
CREATE TABLE `stations` (
  ...
  KEY `name` (`name`),
  KEY `type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='电视台表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stations` VALUES (2,1,0,101,'浙江卫视',1,NULL,'channel01','lantian','channels/lantian/channel01'),(3,1,0,102,'钱江频道',1,'http://img01.cztv.com/channel/test199/1/ac_logo_2684841b622ae80c5088044ea2de73eb.png','ztv2','lantian','channels/lantian/channel02'),(4,1,0,123,'2323',323,NULL,'232132','232132','3213213'),(5,1,343,3423,'45454',34234,'56456546','6547675','565465','564234');
...
-- Dump completed on 2015-09-11 14:30:29
