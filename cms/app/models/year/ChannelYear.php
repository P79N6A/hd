...
class ChannelYear extends Model {
    ...
    public function metaData() {
        return [
            MetaData::MODELS_ATTRIBUTES => [
                'id', 'name', 'shortname', 'tag', 'status', 'channel_logo','channel_logo_slave', 'channel_url', 'channel_instr', 'channel_info',
            ],
            MetaData::MODELS_PRIMARY_KEY => ['id',],
            MetaData::MODELS_NON_PRIMARY_KEY => ['name', 'shortname', 'tag', 'status', 'channel_logo','channel_logo_slave', 'channel_url', 'channel_instr', 'channel_info',],
            MetaData::MODELS_NOT_NULL => ['id', 'name', 'shortname', 'tag', 'status', 'channel_logo','channel_logo_slave', 'channel_url', 'channel_instr', 'channel_info',],
    ...
    public static function deleteChannel($channel_id) {
        return self::findFirst($channel_id)->delete();
    }
